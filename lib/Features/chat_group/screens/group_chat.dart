...
class _GroupChatState extends State<GroupChat> {
  ...
  Future<void> _sendVoiceMessage(String voicePath) async {
    setState(() => _isSending = true);
    try {
      final voiceUrl = await _chatService.uploadVoiceMessage(widget.groupId, voicePath);
      await _chatService.sendMessage(
        groupId: widget.groupId,
        ...
        body: Column(
          children: [
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return MessageBubble(
                    ...
                    isImage: message['imageUrl'] != null,
                    imageUrl: message['imageUrl'],
                    isVoice: message['voiceUrl'] != null, // Added for voice messages
                    voiceUrl: message['voiceUrl'], // Added for voice messages
                  );
                },
              ),
            ),
            ChatInputField(
              ...
              onEmojiPressed: _toggleEmojiPicker,
              onMediaPressed: _pickImage,
              onVoiceMessageRecorded: _sendVoiceMessage, // Added for voice messages
            ),
            if (_showEmojiPicker)
              SizedBox(
                height: 250,
